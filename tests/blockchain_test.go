...
func TestBlockChainBasic(t *testing.T) {
	...
	bc := b.Blockchain{}
	bc.Chain = map[int32][]b.Block{}
	bc.Length = 0
	b.DecodeBlockchainFromJSON(&bc, jsonBlockChain)
	// if err != nil {
	// 	fmt.Println(err)
	// 	t.Fail()
	// }
	//jsonNew, err := bc.EncodeToJson()
	jsonNew := b.EncodeBlockchainToJSON(&bc)
	// if err != nil {
	// 	fmt.Println(err)
	// 	t.Fail()
	// }
	var realValue []b.BlockJson
	var expectedValue []b.BlockJson
