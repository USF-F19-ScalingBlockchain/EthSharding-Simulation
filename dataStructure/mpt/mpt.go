...
func Tests() {
	var mpt = MerklePatriciaTrie{map[string]Node{}, map[string]string{}, ""}
	mpt.Insert("a", "10")
	mpt.Insert("p", "20")
	mpt.Insert("ab", "30")
...
func (mpt *MerklePatriciaTrie) Initial() {
	mpt.Raw_db = make(map[string]string)
